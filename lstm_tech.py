...
best_model_params = {'lookback': 20, 'dropout_rate': 0.1, 'epochs': 100, 'batch_size': 8, 'l2': 0.005}

# Create the best model
best_model = LSTMModel(input_size=len(inp_columns), hidden_size=20 , fcc=20, output_size=1, num_layers=1,
